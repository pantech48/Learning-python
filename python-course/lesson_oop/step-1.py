...
class A:
    ...
    def set_value(self, value):
        # Setter - установщик - задаёт новое значение для св-ва
        self._value = value
"""
...
class Employee:
    ...
    def __init__(self, firstname, lastname, hours_worked, salary_strategy):
        """
        Это конструктор
        Основная и единственная цель - инициализировать объект.
        """
        self._firstname = firstname
        self._lastname = lastname
        self._hours_worked = hours_worked
        self.set_hours_worked(hours_worked)
        self._self_strategy = salary_strategy
    ...
    def set_hours_worked(self, hours_worked):
        if hours_worked <= 0:
            raise ValueError('Amount of work should be positive number')
        self._hourse_worked = hours_worked

    def calculate_salary(self):
        """Считает и возвращает зарплату сотрудника."""
        return self._self_strategy.calculate(self.get_hours_worked())
...
class HourlyPaymentStrategy(SalaryStrategy):
    ...
    def calculate(self, hours_worked):
        ...
        # super().calculate() # НО, в данном примере не нужен!
...
# person1.firstname = 'Игорь' # присвоение/установка значения св-ва
...
person2 = Employee('КОстя', 'Петрович', 100500, FixedRateStrategy(15000))
# print(person2)
# print(person2.get_fullname())
# print(dir(Employee))
...
class CarFactory:
    ...
    def create(cls, number):
        ...
        cls.__cars[number] = Car(number)
        return cls.__cars[number]


car1 = CarFactory.create('a007aa')